...
public class KassapaateTest {
    ...
    @Test
    public void kortilleLisataanRahaaJosLisattavaSummaPositiivinen() {
        kassa.lataa(kortti, 20);
        
        verify(kortti, times(1)).lataa(20);
       
    }
    
    @Test
    public void kortilleEiLadataRahaaJosLisattavaSummaNegatiivinen() {
        kassa.lataa(kortti, -3);
        
        verify(kortti, times(0)).lataa(20);
    }
